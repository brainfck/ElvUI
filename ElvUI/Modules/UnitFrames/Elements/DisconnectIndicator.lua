...
local DisconnectTextures = {
	["DISCONNECT"] = E.Media.ToxiTextures.MaterialDC
}

function UF:Construct_DisconnectIndicator(frame)
	return frame.RaisedElementParent.TextureParent:CreateTexture(nil, "OVERLAY")
end

function UF:Configure_DisconnectIndicator(frame)
